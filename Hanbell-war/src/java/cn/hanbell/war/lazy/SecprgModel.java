 ...
 * @author C0160
 */
public class SecprgModel extends LazyDataModel<Secprg> {

    private SuperEJB superEJB;
    private List<Secprg> dataList;
    private Map<String, Object> filterFields;
    private Map<String, String> sortFields;

    public SecprgModel(SuperEJB superEJB) {
    ...
    public Secprg getRowData(String rowKey) {
        for (Secprg e : dataList) {
            if (e.getPrgno().equals(rowKey)) {
                return e;
            }
        }
        return null;
    ...
    public Object getRowKey(Secprg t) {
        return t.getPrgno();
    }

    public List<Secprg> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
     ...
     * @return the dataList
     */
    public List<Secprg> getDataList() {
        return dataList;
    }
     ...
     */
    public void setDataList(List<Secprg> dataList) {
