 ...
 * @author C1491
 */
public abstract class ErrorMailNotification {

    protected String company;

    protected ErrorMailNotify mail;

    protected String mailFrom = "error@hanbell.com.cn";
    ...
    public void notify(ErrorMailNotify mail) {
        this.mail = mail;
