 ...
 */
@Embeddable
public class REPTAPK implements Serializable {
    ...
    public REPTAPK(String ta001, String ta002) {
        this.ta001 = ta001;
        this.ta002 = ta002;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof REPTAPK)) {
            return false;
        }
        REPTAPK other = (REPTAPK) object;
    ...
    public String toString() {
        return "cn.hanbell.crm.entity.REPTAPK[ ta001=" + ta001 + ", ta002=" + ta002 + " ]";
    }
