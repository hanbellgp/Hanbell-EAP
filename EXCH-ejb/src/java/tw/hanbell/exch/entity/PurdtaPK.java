 ...
 */
@Embeddable
public class PurdtaPK implements Serializable {
    ...
    public PurdtaPK(String facno, String prono, String pono, short trseq) {
        this.facno = facno;
        this.prono = prono;
        this.pono = pono;
        this.trseq = trseq;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PurdtaPK)) {
            return false;
        }
        PurdtaPK other = (PurdtaPK) object;
    ...
    public String toString() {
        return "tw.hanbell.exch.entity.PurdtaPK[ facno=" + facno + ", prono=" + prono + ", pono=" + pono + ", trseq=" + trseq + " ]";
    }
