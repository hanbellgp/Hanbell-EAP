...
public class Purdta implements Serializable {
    ...
    @Column(name = "n_priaskdate")
    @Temporal(TemporalType.TIMESTAMP)
    private Date nPriaskdate;
    @Column(name = "n_replyaskdate")
    @Temporal(TemporalType.TIMESTAMP)
    private Date nReplyaskdate;
    @Size(max = 3)
    @Column(name = "addcode")
    ...
    @Column(name = "oaskdate")
    @Temporal(TemporalType.TIMESTAMP)
    private Date oaskdate;
    ...
    public Date getNPriaskdate() {
        return nPriaskdate;
    }

    public void setNPriaskdate(Date nPriaskdate) {
        this.nPriaskdate = nPriaskdate;
    }

    public Date getNReplyaskdate() {
        return nReplyaskdate;
    }

    public void setNReplyaskdate(Date nReplyaskdate) {
        this.nReplyaskdate = nReplyaskdate;
    }
    ...
    public String getJitstatus() {
        return jitstatus;
    }

    public void setJitstatus(String jitstatus) {
    ...
    public void setNScm(String nScm) {
        this.nScm = nScm;
    }
    ...
    public Date getOaskdate() {
        return oaskdate;
    }

    public void setOaskdate(Date oaskdate) {
        this.oaskdate = oaskdate;
    }
    ...
    public String toString() {
        return "tw.hanbell.exch.entity.Purdta[ purdtaPK=" + purdtaPK + " ]";
    }
