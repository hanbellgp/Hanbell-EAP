...
@NamedQueries({
    ...
    @NamedQuery(name = "HKYX014.findByProcessSerialNumber", query = "SELECT h FROM HKYX014 h WHERE h.processSerialNumber = :processSerialNumber"),
    ...
    @NamedQuery(name = "HKYX014.findByFormSerialNumber", query = "SELECT h FROM HKYX014 h WHERE h.formSerialNumber = :formSerialNumber"),
