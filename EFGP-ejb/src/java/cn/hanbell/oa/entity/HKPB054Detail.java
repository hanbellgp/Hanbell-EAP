...
@NamedQueries({
    ...
    @NamedQuery(name = "HKPB054Detail.findByZr002c", query = "SELECT h FROM HKPB054Detail h WHERE h.zr002c = :zr002c"),
    @NamedQuery(name = "HKPB054Detail.findByZr003c", query = "SELECT h FROM HKPB054Detail h WHERE h.zr003c = :zr003c"),
    @NamedQuery(name = "HKPB054Detail.findByMftNo", query = "SELECT h FROM HKPB054Detail h WHERE h.mftNo = :mftNo"),
    @NamedQuery(name = "HKPB054Detail.findByBl002c", query = "SELECT h FROM HKPB054Detail h WHERE h.bl002c = :bl002c"),
    @NamedQuery(name = "HKPB054Detail.findByNo", query = "SELECT h FROM HKPB054Detail h WHERE h.no = :no"),
    @NamedQuery(name = "HKPB054Detail.findByBl003c", query = "SELECT h FROM HKPB054Detail h WHERE h.bl003c = :bl003c"),
    @NamedQuery(name = "HKPB054Detail.findByJe001c", query = "SELECT h FROM HKPB054Detail h WHERE h.je001c = :je001c"),
    @NamedQuery(name = "HKPB054Detail.findByJe002c", query = "SELECT h FROM HKPB054Detail h WHERE h.je002c = :je002c"),
    @NamedQuery(name = "HKPB054Detail.findByKfno", query = "SELECT h FROM HKPB054Detail h WHERE h.kfno = :kfno"),
    @NamedQuery(name = "HKPB054Detail.findByZr001c", query = "SELECT h FROM HKPB054Detail h WHERE h.zr001c = :zr001c"),
    @NamedQuery(name = "HKPB054Detail.findByJe003c", query = "SELECT h FROM HKPB054Detail h WHERE h.je003c = :je003c"),
    @NamedQuery(name = "HKPB054Detail.findByBl001c", query = "SELECT h FROM HKPB054Detail h WHERE h.bl001c = :bl001c"),
    @NamedQuery(name = "HKPB054Detail.findByJEtotalC", query = "SELECT h FROM HKPB054Detail h WHERE h.jEtotalC = :jEtotalC"),
    @NamedQuery(name = "HKPB054Detail.findByCusds", query = "SELECT h FROM HKPB054Detail h WHERE h.cusds = :cusds"),
    @NamedQuery(name = "HKPB054Detail.findByFSN", query = "SELECT h FROM HKPB054Detail h WHERE h.formSerialNumber = :fsn"),
    @NamedQuery(name = "HKPB054Detail.findBySeq", query = "SELECT h FROM HKPB054Detail h WHERE h.seq = :seq")})
