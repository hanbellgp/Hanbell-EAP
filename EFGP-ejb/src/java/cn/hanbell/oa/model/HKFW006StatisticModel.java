 ...
 * @author C2082
 */
public class HKFW006StatisticModel implements Serializable{
    private String dept;
    ...
    public HKFW006StatisticModel(String dept, String statistic, int month1, int month2, int month3, int month4, int month5, int month6, int month7, int month8, int month9, int month10, int month11, int month12, int sum) {
        this.dept = dept;
