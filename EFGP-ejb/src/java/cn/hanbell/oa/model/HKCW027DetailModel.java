 ...
 * @author S31106868hb
 */
public class HKCW027DetailModel implements Serializable {
  ...
  @Size(max = 255)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HKCW027DetailModel)) {
            return false;
        }
        HKCW027DetailModel other = (HKCW027DetailModel) object;
        return true;
    }

    @Override
    public String toString() {
        return "cn.hanbell.oa.entity.HKCW027Detail";
    }
