...
public class MCHZCW028 extends HmacSha1Signature{
    ...
    public void setItems(List<MCHZCW028reDetail> items) {
        this.items = items;
    }

    public List<MCHZCW028tDetail> getTravel_items() {
        return travel_items;
    }

    public void setTravel_items(List<MCHZCW028tDetail> travel_items) {
