...
import cn.hanbell.costctrl.app.MCHZCW033;
import cn.hanbell.costctrl.app.MCHZCW033reDetail;
import cn.hanbell.costctrl.app.MCHZCW033tDetail;
...
import cn.hanbell.oa.model.HZCW033Model;
import cn.hanbell.oa.model.HZCW033reDetailModel;
import cn.hanbell.oa.model.HZCW033tDetailModel;
 ...
 */
@Path("costctrl/hzcw033")
@javax.enterprise.context.RequestScoped
public class HZCW033FacadeREST extends SuperRESTForEFGP<HZCW033> {
...
//    UserTransaction tran;
    ...
    public MCResponseData CreateOAHZCWO33(MCHZCW033 entity) {
        ...
        try {
            ...
            //实例化对象
            HZCW033Model m = new HZCW033Model();
            List<MCHZCW033reDetail> reds = entity.getItems();
            ...
            if (!reds.isEmpty()) {
                ...
                for (MCHZCW033reDetail re : reds) {
                    ...
                    rem.setLoanAmount(re.getLoanAmount());
                    rem.setApplyAmount(re.getApplyAmount());
                    rem.setLoanProp("HZCW017");
            ...
            if (tds != null && !tds.isEmpty()) {
                ...
                for (MCHZCW033tDetail td : tds) {
                    tseq++;
                    HZCW033tDetailModel tm = new HZCW033tDetailModel();
                    tm.setNo(tseq);
    ...
    public MCResponseData checkBeforeSend(int status, MCHZCW033 mc) {
        ...
        try {
            ...
            for (MCHZCW033reDetail r : items) {
                ...
                String loanNo = r.getLoanNo();
                if (null == loanNo || "".equals(loanNo)) {
                    code = 107;
                    msg = "借支单号错误";
                    return new MCResponseData(code, msg);
                }
                if (hzcw017Bean.findByPSN(loanNo) == null) {
                    code = 107;
                    msg = "借支单号错误";
                    return new MCResponseData(code, msg);
                }
    ...
    public boolean initialCRMWorkDetail(MCHZCW033 mc) {
        try {
            ...
            if ("YXJL".equals(crmtype)) {
                ...
                if (salfi != null) {
                    ...
                    //差旅费含其他
                    for (MCHZCW033reDetail re : reDetails) {
