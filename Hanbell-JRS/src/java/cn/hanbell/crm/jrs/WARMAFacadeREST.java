...
public class WARMAFacadeREST extends SuperRESTForCRM<WARMA> {
    ...
    public ResponseData<JSONObject> findProductType(@QueryParam("searchWord") String MA003) {
    ...
    @Produces({MediaType.APPLICATION_JSON})
    public ResponseData<JSONObject> findProductQuality(@QueryParam("searchWord") String MB002) {
