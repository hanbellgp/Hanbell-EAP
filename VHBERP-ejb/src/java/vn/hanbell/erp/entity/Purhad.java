...
public class Purhad implements Serializable {
    ...
    public Purhad(PurhadPK purhadPK, Character decode, Date podate, String buyer, String coin, BigDecimal ratio, String termcode, Character paycom, Character paycode, String sndcode, String addcode, Character tax, BigDecimal taxrate, BigDecimal poamts, BigDecimal taxamts, BigDecimal totamts, Character hposta, String userno, Date indate, short prtcnt, Character relyn, Character triyn) {
        this.purhadPK = purhadPK;
        this.decode = decode;
        this.podate = podate;
        this.buyer = buyer;
    ...
    @XmlTransient
    public List<Purdta> getPurdtaList() {
        return purdtaList;
    }

    public void setPurdtaList(List<Purdta> purdtaList) {
        this.purdtaList = purdtaList;
    }
    ...
    public String toString() {
        return "vn.hanbell.erp.entity.Purhad[ purhadPK=" + purhadPK + " ]";
    }
