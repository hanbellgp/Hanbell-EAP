...
@NamedQueries({
    ...
    @NamedQuery(name = "Cdrcus.findByShptrseq", query = "SELECT c FROM Cdrcus c WHERE c.shptrseq = :shptrseq"),
    @NamedQuery(name = "Cdrcus.findByIvotrseq", query = "SELECT c FROM Cdrcus c WHERE c.ivotrseq = :ivotrseq"),
    @NamedQuery(name = "Cdrcus.findBySndcode", query = "SELECT c FROM Cdrcus c WHERE c.sndcode = :sndcode"),
    @NamedQuery(name = "Cdrcus.findByPaycode", query = "SELECT c FROM Cdrcus c WHERE c.paycode = :paycode"),
    @NamedQuery(name = "Cdrcus.findByTermcode", query = "SELECT c FROM Cdrcus c WHERE c.termcode = :termcode"),
    @NamedQuery(name = "Cdrcus.findByPaysepcode", query = "SELECT c FROM Cdrcus c WHERE c.paysepcode = :paysepcode"),
    @NamedQuery(name = "Cdrcus.findBySeldate1", query = "SELECT c FROM Cdrcus c WHERE c.seldate1 = :seldate1"),
    @NamedQuery(name = "Cdrcus.findBySeldate2", query = "SELECT c FROM Cdrcus c WHERE c.seldate2 = :seldate2"),
    @NamedQuery(name = "Cdrcus.findBySeldate3", query = "SELECT c FROM Cdrcus c WHERE c.seldate3 = :seldate3"),
    @NamedQuery(name = "Cdrcus.findBySeldate4", query = "SELECT c FROM Cdrcus c WHERE c.seldate4 = :seldate4"),
    @NamedQuery(name = "Cdrcus.findByHandays1", query = "SELECT c FROM Cdrcus c WHERE c.handays1 = :handays1"),
    @NamedQuery(name = "Cdrcus.findByHandays2", query = "SELECT c FROM Cdrcus c WHERE c.handays2 = :handays2"),
    @NamedQuery(name = "Cdrcus.findByHandays3", query = "SELECT c FROM Cdrcus c WHERE c.handays3 = :handays3"),
    @NamedQuery(name = "Cdrcus.findByHandays4", query = "SELECT c FROM Cdrcus c WHERE c.handays4 = :handays4"),
    @NamedQuery(name = "Cdrcus.findByTickdays", query = "SELECT c FROM Cdrcus c WHERE c.tickdays = :tickdays"),
    @NamedQuery(name = "Cdrcus.findBySacode", query = "SELECT c FROM Cdrcus c WHERE c.sacode = :sacode"),
    @NamedQuery(name = "Cdrcus.findByAreacode", query = "SELECT c FROM Cdrcus c WHERE c.areacode = :areacode"),
    @NamedQuery(name = "Cdrcus.findByCuycode", query = "SELECT c FROM Cdrcus c WHERE c.cuycode = :cuycode"),
    @NamedQuery(name = "Cdrcus.findByBoss", query = "SELECT c FROM Cdrcus c WHERE c.boss = :boss"),
    @NamedQuery(name = "Cdrcus.findByContactman", query = "SELECT c FROM Cdrcus c WHERE c.contactman = :contactman"),
    @NamedQuery(name = "Cdrcus.findByTel1", query = "SELECT c FROM Cdrcus c WHERE c.tel1 = :tel1"),
    @NamedQuery(name = "Cdrcus.findByFax", query = "SELECT c FROM Cdrcus c WHERE c.fax = :fax"),
    @NamedQuery(name = "Cdrcus.findByZonenum", query = "SELECT c FROM Cdrcus c WHERE c.zonenum = :zonenum"),
    @NamedQuery(name = "Cdrcus.findByMchdate", query = "SELECT c FROM Cdrcus c WHERE c.mchdate = :mchdate"),
    @NamedQuery(name = "Cdrcus.findByCusgroup", query = "SELECT c FROM Cdrcus c WHERE c.cusgroup = :cusgroup"),
    @NamedQuery(name = "Cdrcus.findByBegdate", query = "SELECT c FROM Cdrcus c WHERE c.begdate = :begdate"),
    @NamedQuery(name = "Cdrcus.findByLatdate", query = "SELECT c FROM Cdrcus c WHERE c.latdate = :latdate"),
    @NamedQuery(name = "Cdrcus.findByCapamt", query = "SELECT c FROM Cdrcus c WHERE c.capamt = :capamt"),
    @NamedQuery(name = "Cdrcus.findByYearamt", query = "SELECT c FROM Cdrcus c WHERE c.yearamt = :yearamt"),
    @NamedQuery(name = "Cdrcus.findByDestarea", query = "SELECT c FROM Cdrcus c WHERE c.destarea = :destarea"),
    @NamedQuery(name = "Cdrcus.findByAgentfacno", query = "SELECT c FROM Cdrcus c WHERE c.agentfacno = :agentfacno"),
    @NamedQuery(name = "Cdrcus.findByPortfacno", query = "SELECT c FROM Cdrcus c WHERE c.portfacno = :portfacno"),
    @NamedQuery(name = "Cdrcus.findByLoadport", query = "SELECT c FROM Cdrcus c WHERE c.loadport = :loadport"),
    @NamedQuery(name = "Cdrcus.findByDiscport", query = "SELECT c FROM Cdrcus c WHERE c.discport = :discport"),
    @NamedQuery(name = "Cdrcus.findByCheckfacno", query = "SELECT c FROM Cdrcus c WHERE c.checkfacno = :checkfacno"),
    @NamedQuery(name = "Cdrcus.findByShipfacno", query = "SELECT c FROM Cdrcus c WHERE c.shipfacno = :shipfacno"),
    @NamedQuery(name = "Cdrcus.findByCommrate", query = "SELECT c FROM Cdrcus c WHERE c.commrate = :commrate"),
    @NamedQuery(name = "Cdrcus.findByMarkno", query = "SELECT c FROM Cdrcus c WHERE c.markno = :markno"),
    @NamedQuery(name = "Cdrcus.findByMark1", query = "SELECT c FROM Cdrcus c WHERE c.mark1 = :mark1"),
    @NamedQuery(name = "Cdrcus.findByMapbilyn", query = "SELECT c FROM Cdrcus c WHERE c.mapbilyn = :mapbilyn"),
    @NamedQuery(name = "Cdrcus.findByIndate", query = "SELECT c FROM Cdrcus c WHERE c.indate = :indate"),
    @NamedQuery(name = "Cdrcus.findByUserno", query = "SELECT c FROM Cdrcus c WHERE c.userno = :userno"),
    @NamedQuery(name = "Cdrcus.findByTaxrate", query = "SELECT c FROM Cdrcus c WHERE c.taxrate = :taxrate"),
    @NamedQuery(name = "Cdrcus.findByBilcategory", query = "SELECT c FROM Cdrcus c WHERE c.bilcategory = :bilcategory"),
    @NamedQuery(name = "Cdrcus.findByOpbankno", query = "SELECT c FROM Cdrcus c WHERE c.opbankno = :opbankno"),
    @NamedQuery(name = "Cdrcus.findByOpbankna", query = "SELECT c FROM Cdrcus c WHERE c.opbankna = :opbankna"),
    @NamedQuery(name = "Cdrcus.findByOpbanknum", query = "SELECT c FROM Cdrcus c WHERE c.opbanknum = :opbanknum"),
    @NamedQuery(name = "Cdrcus.findByPrnyn", query = "SELECT c FROM Cdrcus c WHERE c.prnyn = :prnyn"),
    @NamedQuery(name = "Cdrcus.findByVdrno", query = "SELECT c FROM Cdrcus c WHERE c.vdrno = :vdrno"),
    @NamedQuery(name = "Cdrcus.findByCusbakna", query = "SELECT c FROM Cdrcus c WHERE c.cusbakna = :cusbakna"),
    @NamedQuery(name = "Cdrcus.findByCusacctno", query = "SELECT c FROM Cdrcus c WHERE c.cusacctno = :cusacctno"),
    @NamedQuery(name = "Cdrcus.findByMark2", query = "SELECT c FROM Cdrcus c WHERE c.mark2 = :mark2"),
    @NamedQuery(name = "Cdrcus.findByShr", query = "SELECT c FROM Cdrcus c WHERE c.shr = :shr"),
    @NamedQuery(name = "Cdrcus.findByShzt", query = "SELECT c FROM Cdrcus c WHERE c.shzt = :shzt"),
    @NamedQuery(name = "Cdrcus.findByIncprerec", query = "SELECT c FROM Cdrcus c WHERE c.incprerec = :incprerec"),
    @NamedQuery(name = "Cdrcus.findByCusnaprt", query = "SELECT c FROM Cdrcus c WHERE c.cusnaprt = :cusnaprt")})
public class Cdrcus implements Serializable {
    ...
    public String toString() {
        return "vn.hanbell.erp.entity.Cdrcus[ cusno=" + cusno + " ]";
    }
