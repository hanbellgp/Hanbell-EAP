 ...
 */
@Embeddable
public class CdrqhadPK implements Serializable {
    ...
    public CdrqhadPK(String facno, String quono) {
        this.facno = facno;
        this.quono = quono;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrqhadPK)) {
            return false;
        }
        CdrqhadPK other = (CdrqhadPK) object;
    ...
    public String toString() {
        return "vn.hanbell.erp.entity.CdrqhadPK[ facno=" + facno + ", quono=" + quono + " ]";
    }
