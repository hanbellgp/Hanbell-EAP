...
public class Apmpay implements Serializable {
    ...
    public Apmpay(String facno, Character paycode, String payno) {
        this.apmpayPK = new ApmpayPK(facno, paycode, payno);
    }
    ...
    @XmlTransient
    public List<Apmpad> getApmpadList() {
        return apmpadList;
    }

    public void setApmpadList(List<Apmpad> apmpadList) {
        this.apmpadList = apmpadList;
    }
