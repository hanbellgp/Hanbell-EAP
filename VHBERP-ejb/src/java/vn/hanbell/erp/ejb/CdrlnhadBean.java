...
import vn.hanbell.erp.entity.CdrlndtaPK;
import vn.hanbell.erp.entity.Cdrlnhad;
...
public class CdrlnhadBean extends SuperEJBForERP<Cdrlnhad> {
    ...
    public Boolean initByOAVHFW004(String psn) {
        List<VHFW004Detail> oaDetails = new ArrayList<>();
        try {
            ...
            oaDetails=vhfw004Bean.getDetailList(e.getFormSerialNumber());
            if (oaDetails.isEmpty()) {
                throw new NullPointerException();
            }
            String trtype = null;
            ...
            for (VHFW004Detail d :oaDetails) {
                ...
                cdrlndta.setWareh(d.getTB010txt());
                cdrlndta.setFixnr(d.getTB011txt());
