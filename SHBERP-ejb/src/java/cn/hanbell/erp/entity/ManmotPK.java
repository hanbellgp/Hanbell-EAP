 ...
 */
@Embeddable
public class ManmotPK implements Serializable {
    ...
    public ManmotPK(String facno, String prono, String manno) {
        this.facno = facno;
        this.prono = prono;
        this.manno = manno;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ManmotPK)) {
            return false;
        }
        ManmotPK other = (ManmotPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.ManmotPK[ facno=" + facno + ", prono=" + prono + ", manno=" + manno + " ]";
    }
