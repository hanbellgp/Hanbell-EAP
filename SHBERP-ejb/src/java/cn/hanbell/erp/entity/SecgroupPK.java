 ...
 */
@Embeddable
public class SecgroupPK implements Serializable {
    ...
    public SecgroupPK(String groupno, String gtype) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SecgroupPK)) {
            return false;
        }
        SecgroupPK other = (SecgroupPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.SecgroupPK[ groupno=" + groupno + ", gtype=" + gtype + " ]";
    }
