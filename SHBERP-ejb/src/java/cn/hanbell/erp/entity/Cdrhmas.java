...
public class Cdrhmas implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "cdrhmas")
    private List<Cdrdmas> cdrdmasList;
    ...
    public Cdrhmas() {
        this.prtcnt = (short) 0;
        this.lcsamts = BigDecimal.ZERO;
        this.ppreamts = BigDecimal.ZERO;
        this.preamts = BigDecimal.ZERO;
        this.ipreamts = BigDecimal.ZERO;
        this.mpreamts = BigDecimal.ZERO;
        this.tranprno = "Z";
        this.ultCode = '0';
        this.invoiceyn = 'N';
        this.piprtcnt = (short) 0;
        this.mfgcode = 'N';
        this.spcode = 'N';
        this.psamts = BigDecimal.ZERO;
        this.msamts = BigDecimal.ZERO;
    }
    ...
    @XmlTransient
    public List<Cdrdmas> getCdrdmasList() {
        return cdrdmasList;
    }

    public void setCdrdmasList(List<Cdrdmas> cdrdmasList) {
        this.cdrdmasList = cdrdmasList;
    }
