 ...
 */
@Embeddable
public class CdrbdtaPK implements Serializable {
    ...
    public CdrbdtaPK(String facno, String bakno, short trseq) {
        this.facno = facno;
        this.bakno = bakno;
        this.trseq = trseq;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrbdtaPK)) {
            return false;
        }
        CdrbdtaPK other = (CdrbdtaPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.CdrbdtaPK[ facno=" + facno + ", bakno=" + bakno + ", trseq=" + trseq + " ]";
    }
