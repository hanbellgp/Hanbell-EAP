 ...
 */
@Embeddable
public class CdrqbomsubPK implements Serializable {
    ...
    public CdrqbomsubPK(String facno, String cdrno, short trseq) {
        this.facno = facno;
        this.cdrno = cdrno;
        this.trseq = trseq;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrqbomsubPK)) {
            return false;
        }
        CdrqbomsubPK other = (CdrqbomsubPK) object;
