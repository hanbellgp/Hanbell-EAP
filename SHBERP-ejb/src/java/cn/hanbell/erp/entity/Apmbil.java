...
@NamedQueries({
    ...
    @NamedQuery(name = "Apmbil.findByBilorg", query = "SELECT a FROM Apmbil a WHERE a.bilorg = :bilorg"),
    @NamedQuery(name = "Apmbil.findByBilamt", query = "SELECT a FROM Apmbil a WHERE a.bilamt = :bilamt"),
    @NamedQuery(name = "Apmbil.findByBiltax", query = "SELECT a FROM Apmbil a WHERE a.biltax = :biltax"),
    @NamedQuery(name = "Apmbil.findByAcpamt", query = "SELECT a FROM Apmbil a WHERE a.acpamt = :acpamt"),
    @NamedQuery(name = "Apmbil.findByPreamt", query = "SELECT a FROM Apmbil a WHERE a.preamt = :preamt"),
    ...
    @NamedQuery(name = "Apmbil.findByCoin", query = "SELECT a FROM Apmbil a WHERE a.coin = :coin"),
    @NamedQuery(name = "Apmbil.findByRatio", query = "SELECT a FROM Apmbil a WHERE a.ratio = :ratio"),
    @NamedQuery(name = "Apmbil.findByPayda", query = "SELECT a FROM Apmbil a WHERE a.payda = :payda"),
    @NamedQuery(name = "Apmbil.findByTerda", query = "SELECT a FROM Apmbil a WHERE a.terda = :terda"),
    @NamedQuery(name = "Apmbil.findByExpamtfs", query = "SELECT a FROM Apmbil a WHERE a.expamtfs = :expamtfs"),
    @NamedQuery(name = "Apmbil.findByExpamt", query = "SELECT a FROM Apmbil a WHERE a.expamt = :expamt"),
    @NamedQuery(name = "Apmbil.findByExtamtfs", query = "SELECT a FROM Apmbil a WHERE a.extamtfs = :extamtfs"),
    @NamedQuery(name = "Apmbil.findByExtamt", query = "SELECT a FROM Apmbil a WHERE a.extamt = :extamt"),
    @NamedQuery(name = "Apmbil.findByYeamtfs", query = "SELECT a FROM Apmbil a WHERE a.yeamtfs = :yeamtfs"),
    @NamedQuery(name = "Apmbil.findByYeamt", query = "SELECT a FROM Apmbil a WHERE a.yeamt = :yeamt"),
    ...
    @NamedQuery(name = "Apmbil.findByTaxfacno", query = "SELECT a FROM Apmbil a WHERE a.taxfacno = :taxfacno"),
    @NamedQuery(name = "Apmbil.findByLosamtfs", query = "SELECT a FROM Apmbil a WHERE a.losamtfs = :losamtfs"),
    @NamedQuery(name = "Apmbil.findByLosamt", query = "SELECT a FROM Apmbil a WHERE a.losamt = :losamt"),
    @NamedQuery(name = "Apmbil.findByTemamtfs", query = "SELECT a FROM Apmbil a WHERE a.temamtfs = :temamtfs"),
    @NamedQuery(name = "Apmbil.findByTemamt", query = "SELECT a FROM Apmbil a WHERE a.temamt = :temamt"),
    @NamedQuery(name = "Apmbil.findByFixyn", query = "SELECT a FROM Apmbil a WHERE a.fixyn = :fixyn"),
    @NamedQuery(name = "Apmbil.findByPayptn", query = "SELECT a FROM Apmbil a WHERE a.payptn = :payptn"),
    @NamedQuery(name = "Apmbil.findByFixtyn", query = "SELECT a FROM Apmbil a WHERE a.fixtyn = :fixtyn"),
    @NamedQuery(name = "Apmbil.findByTaxbase", query = "SELECT a FROM Apmbil a WHERE a.taxbase = :taxbase"),
    @NamedQuery(name = "Apmbil.findByTaxrate", query = "SELECT a FROM Apmbil a WHERE a.taxrate = :taxrate"),
    @NamedQuery(name = "Apmbil.findByBilcategory", query = "SELECT a FROM Apmbil a WHERE a.bilcategory = :bilcategory"),
