...
@NamedQueries({
    ...
    @NamedQuery(name = "Apmapd.findByTrseq", query = "SELECT a FROM Apmapd a WHERE a.apmapdPK.trseq = :trseq"),
    ...
    @NamedQuery(name = "Apmapd.findByItnbr", query = "SELECT a FROM Apmapd a WHERE a.itnbr = :itnbr"),
    @NamedQuery(name = "Apmapd.findByItdsc", query = "SELECT a FROM Apmapd a WHERE a.itdsc = :itdsc"),
    @NamedQuery(name = "Apmapd.findByApdsc", query = "SELECT a FROM Apmapd a WHERE a.apdsc = :apdsc"),
    @NamedQuery(name = "Apmapd.findByOgdkid", query = "SELECT a FROM Apmapd a WHERE a.ogdkid = :ogdkid"),
    @NamedQuery(name = "Apmapd.findByCoin", query = "SELECT a FROM Apmapd a WHERE a.coin = :coin"),
    @NamedQuery(name = "Apmapd.findByRatio", query = "SELECT a FROM Apmapd a WHERE a.ratio = :ratio"),
    @NamedQuery(name = "Apmapd.findByPayqty", query = "SELECT a FROM Apmapd a WHERE a.payqty = :payqty"),
    @NamedQuery(name = "Apmapd.findByPric", query = "SELECT a FROM Apmapd a WHERE a.pric = :pric"),
    @NamedQuery(name = "Apmapd.findByAcpamtfs", query = "SELECT a FROM Apmapd a WHERE a.acpamtfs = :acpamtfs"),
    @NamedQuery(name = "Apmapd.findByAcpamt", query = "SELECT a FROM Apmapd a WHERE a.acpamt = :acpamt"),
    @NamedQuery(name = "Apmapd.findByPreamtfs", query = "SELECT a FROM Apmapd a WHERE a.preamtfs = :preamtfs"),
    @NamedQuery(name = "Apmapd.findByPreamt", query = "SELECT a FROM Apmapd a WHERE a.preamt = :preamt"),
    @NamedQuery(name = "Apmapd.findByTemamtfs", query = "SELECT a FROM Apmapd a WHERE a.temamtfs = :temamtfs"),
    @NamedQuery(name = "Apmapd.findByTemamt", query = "SELECT a FROM Apmapd a WHERE a.temamt = :temamt"),
    @NamedQuery(name = "Apmapd.findByApamtfs", query = "SELECT a FROM Apmapd a WHERE a.apamtfs = :apamtfs"),
    @NamedQuery(name = "Apmapd.findByApamt", query = "SELECT a FROM Apmapd a WHERE a.apamt = :apamt"),
    @NamedQuery(name = "Apmapd.findByBilno", query = "SELECT a FROM Apmapd a WHERE a.bilno = :bilno"),
    @NamedQuery(name = "Apmapd.findByDmark", query = "SELECT a FROM Apmapd a WHERE a.dmark = :dmark"),
    @NamedQuery(name = "Apmapd.findByTrapyh", query = "SELECT a FROM Apmapd a WHERE a.trapyh = :trapyh"),
    @NamedQuery(name = "Apmapd.findByExpamtfs", query = "SELECT a FROM Apmapd a WHERE a.expamtfs = :expamtfs"),
    @NamedQuery(name = "Apmapd.findByExpamt", query = "SELECT a FROM Apmapd a WHERE a.expamt = :expamt"),
    @NamedQuery(name = "Apmapd.findByIvops", query = "SELECT a FROM Apmapd a WHERE a.ivops = :ivops"),
    @NamedQuery(name = "Apmapd.findByIvoms", query = "SELECT a FROM Apmapd a WHERE a.ivoms = :ivoms"),
    @NamedQuery(name = "Apmapd.findByIvopsfs", query = "SELECT a FROM Apmapd a WHERE a.ivopsfs = :ivopsfs"),
    @NamedQuery(name = "Apmapd.findByIvomsfs", query = "SELECT a FROM Apmapd a WHERE a.ivomsfs = :ivomsfs"),
    @NamedQuery(name = "Apmapd.findByLosamtfs", query = "SELECT a FROM Apmapd a WHERE a.losamtfs = :losamtfs"),
    @NamedQuery(name = "Apmapd.findByLosamt", query = "SELECT a FROM Apmapd a WHERE a.losamt = :losamt"),
    @NamedQuery(name = "Apmapd.findByTax", query = "SELECT a FROM Apmapd a WHERE a.tax = :tax"),
    @NamedQuery(name = "Apmapd.findByTaxrate", query = "SELECT a FROM Apmapd a WHERE a.taxrate = :taxrate"),
    @NamedQuery(name = "Apmapd.findByCenterid", query = "SELECT a FROM Apmapd a WHERE a.centerid = :centerid"),
