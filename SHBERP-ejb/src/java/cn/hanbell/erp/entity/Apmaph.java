...
public class Apmaph implements Serializable {
    ...
    public Character getIsretmoney() {
        return isretmoney;
    }

    public void setIsretmoney(Character isretmoney) {
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.Apmaph[ apmaphPK=" + apmaphPK + " ]";
    }
