 ...
 */
@Embeddable
public class ApmchpPK implements Serializable {
    ...
    public ApmchpPK(String facno, String trno, String vdrno, String accno, String detno, short trseq) {
        this.facno = facno;
        this.trno = trno;
        this.vdrno = vdrno;
        this.accno = accno;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ApmchpPK)) {
            return false;
        }
        ApmchpPK other = (ApmchpPK) object;
    ...
    public String toString() {
        return "cn.hanbell.erp.entity.ApmchpPK[ facno=" + facno + ", trno=" + trno + ", vdrno=" + vdrno + ", accno=" + accno + ", detno=" + detno + ", trseq=" + trseq + " ]";
    }
