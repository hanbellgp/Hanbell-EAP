...
@NamedQueries({
    ...
    @NamedQuery(name = "Apmtbil.findByUniform", query = "SELECT a FROM Apmtbil a WHERE a.uniform = :uniform"),
    @NamedQuery(name = "Apmtbil.findByBilkid", query = "SELECT a FROM Apmtbil a WHERE a.bilkid = :bilkid"),
    @NamedQuery(name = "Apmtbil.findByChgno", query = "SELECT a FROM Apmtbil a WHERE a.chgno = :chgno"),
    @NamedQuery(name = "Apmtbil.findByDepno", query = "SELECT a FROM Apmtbil a WHERE a.depno = :depno"),
    @NamedQuery(name = "Apmtbil.findByBilamt", query = "SELECT a FROM Apmtbil a WHERE a.bilamt = :bilamt"),
    @NamedQuery(name = "Apmtbil.findByBiltax", query = "SELECT a FROM Apmtbil a WHERE a.biltax = :biltax"),
    @NamedQuery(name = "Apmtbil.findByPreamt", query = "SELECT a FROM Apmtbil a WHERE a.preamt = :preamt"),
    @NamedQuery(name = "Apmtbil.findByTemamt", query = "SELECT a FROM Apmtbil a WHERE a.temamt = :temamt"),
    @NamedQuery(name = "Apmtbil.findByLosamt", query = "SELECT a FROM Apmtbil a WHERE a.losamt = :losamt"),
    @NamedQuery(name = "Apmtbil.findByCstamt", query = "SELECT a FROM Apmtbil a WHERE a.cstamt = :cstamt"),
    @NamedQuery(name = "Apmtbil.findByChgamt", query = "SELECT a FROM Apmtbil a WHERE a.chgamt = :chgamt"),
    @NamedQuery(name = "Apmtbil.findByBilamtfs", query = "SELECT a FROM Apmtbil a WHERE a.bilamtfs = :bilamtfs"),
    @NamedQuery(name = "Apmtbil.findByBiltaxfs", query = "SELECT a FROM Apmtbil a WHERE a.biltaxfs = :biltaxfs"),
    @NamedQuery(name = "Apmtbil.findByPreamtfs", query = "SELECT a FROM Apmtbil a WHERE a.preamtfs = :preamtfs"),
    @NamedQuery(name = "Apmtbil.findByTemamtfs", query = "SELECT a FROM Apmtbil a WHERE a.temamtfs = :temamtfs"),
    @NamedQuery(name = "Apmtbil.findByLosamtfs", query = "SELECT a FROM Apmtbil a WHERE a.losamtfs = :losamtfs"),
    @NamedQuery(name = "Apmtbil.findByCstamtfs", query = "SELECT a FROM Apmtbil a WHERE a.cstamtfs = :cstamtfs"),
    @NamedQuery(name = "Apmtbil.findByChgamtfs", query = "SELECT a FROM Apmtbil a WHERE a.chgamtfs = :chgamtfs"),
    @NamedQuery(name = "Apmtbil.findByCoin", query = "SELECT a FROM Apmtbil a WHERE a.coin = :coin"),
    @NamedQuery(name = "Apmtbil.findByRatio", query = "SELECT a FROM Apmtbil a WHERE a.ratio = :ratio"),
    @NamedQuery(name = "Apmtbil.findByUsrno", query = "SELECT a FROM Apmtbil a WHERE a.usrno = :usrno"),
    @NamedQuery(name = "Apmtbil.findByFixyn", query = "SELECT a FROM Apmtbil a WHERE a.fixyn = :fixyn"),
    @NamedQuery(name = "Apmtbil.findByProno", query = "SELECT a FROM Apmtbil a WHERE a.prono = :prono"),
    @NamedQuery(name = "Apmtbil.findByBilorg", query = "SELECT a FROM Apmtbil a WHERE a.bilorg = :bilorg"),
    @NamedQuery(name = "Apmtbil.findByTaxrate", query = "SELECT a FROM Apmtbil a WHERE a.taxrate = :taxrate"),
    @NamedQuery(name = "Apmtbil.findByBilcategory", query = "SELECT a FROM Apmtbil a WHERE a.bilcategory = :bilcategory"),
    ...
    @NamedQuery(name = "Apmtbil.findByOpbanknum", query = "SELECT a FROM Apmtbil a WHERE a.opbanknum = :opbanknum"),
    @NamedQuery(name = "Apmtbil.findByTaxbase", query = "SELECT a FROM Apmtbil a WHERE a.taxbase = :taxbase"),
    @NamedQuery(name = "Apmtbil.findByExtamtfs", query = "SELECT a FROM Apmtbil a WHERE a.extamtfs = :extamtfs"),
    @NamedQuery(name = "Apmtbil.findByExtamt", query = "SELECT a FROM Apmtbil a WHERE a.extamt = :extamt"),
    @NamedQuery(name = "Apmtbil.findByPK", query = "SELECT a FROM Apmtbil a WHERE a.apmtbilPK.facno = :facno AND a.apmtbilPK.bilno = :bilno"),
    @NamedQuery(name = "Apmtbil.findByExpamt", query = "SELECT a FROM Apmtbil a WHERE a.expamt = :expamt")})
