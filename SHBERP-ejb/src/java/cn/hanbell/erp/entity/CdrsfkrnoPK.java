 ...
 */
@Embeddable
public class CdrsfkrnoPK implements Serializable {
    ...
    public CdrsfkrnoPK(String facno, String trtype, String keyformat) {
        this.facno = facno;
        this.trtype = trtype;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CdrsfkrnoPK)) {
            return false;
        }
        CdrsfkrnoPK other = (CdrsfkrnoPK) object;
