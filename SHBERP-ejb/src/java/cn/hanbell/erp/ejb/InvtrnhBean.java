...
public class InvtrnhBean extends SuperEJBForERP<Invtrnh> {
    ...
    public List<Object[]> getInvtrnhByINV555(String facno, Date queryDateBegin, Date queryDateEnd, String queryno, String querytype, String querywareh, String querydept, String queryuser) {
        ...
        sql.append(" invmas.itdsc,invcls.itcls,invcls.clsdsc,invcls.itclscode, invtrnh.wareh,invwh.whdsc, invtrnh.trnqy1,invtrnh.unmsr1,invtrnh.tramt,invtrnh.userno, invtrnh.iocode,invdou.reskind,invtrnh.rescode,invdou.hmark1");
