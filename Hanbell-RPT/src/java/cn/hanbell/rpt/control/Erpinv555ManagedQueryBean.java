 ...
 * @author C1879
 */
@ManagedBean(name = "erpinv555ManagedQueryBean")
@javax.faces.bean.ViewScoped
public class Erpinv555ManagedQueryBean extends PagerBean<String[]> {
    ...
    public Erpinv555ManagedQueryBean() {
    }
    ...
    public void query() {
        ...
        try {
            totallist = invtrnhBean.getINV555(queryDateBegin, queryDateEnd, map);
