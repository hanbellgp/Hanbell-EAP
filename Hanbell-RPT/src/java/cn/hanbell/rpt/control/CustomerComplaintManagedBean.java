...
public class CustomerComplaintManagedBean extends SuperQueryBean<CustomerComplaint> {
    ...
    public void print() {
        ...
        for (CustomerComplaint cp : entityList) {
            ...
            cell8.setCellValue(cp.getMaterialcost().doubleValue());
            Cell cell9 = row.createCell(9);
            cell9.setCellStyle(style.get("cell"));
            cell9.setCellValue(cp.getLabourcost().doubleValue());
            Cell cell10 = row.createCell(10);
            cell10.setCellStyle(style.get("cell"));
            cell10.setCellValue(cp.getTansportexpense().doubleValue());
            Cell cell11 = row.createCell(11);
            cell11.setCellStyle(style.get("cell"));
            cell11.setCellValue(cp.getTravelexpense().doubleValue());
            Cell cell12 = row.createCell(12);
            cell12.setCellStyle(style.get("cell"));
            cell12.setCellValue(cp.getClaimamount().doubleValue());
            Cell cell13 = row.createCell(13);
            cell13.setCellStyle(style.get("cell"));
            cell13.setCellValue(cp.getOthercost().doubleValue());
            Cell cell14 = row.createCell(14);
            cell14.setCellStyle(style.get("cell"));
            cell14.setCellValue(cp.getTotalamount().doubleValue());
    ...
    public void selectCreateCustomerComplaint() {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", kfno + ex.toString()));
        }
