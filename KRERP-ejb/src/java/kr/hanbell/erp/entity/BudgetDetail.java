...
@NamedQueries({
    ...
    , @NamedQuery(name = "BudgetDetail.findByPeriod", query = "SELECT b FROM BudgetDetail b WHERE b.budgetDetailPK.period = :period")
    , @NamedQuery(name = "BudgetDetail.findByCenterid", query = "SELECT b FROM BudgetDetail b WHERE b.budgetDetailPK.centerid = :centerid")
    , @NamedQuery(name = "BudgetDetail.findByBudgetacc", query = "SELECT b FROM BudgetDetail b WHERE b.budgetDetailPK.budgetacc = :budgetacc")
...
public class BudgetDetail implements Serializable {
    ...
    public String toString() {
        return "vn.hanbell.erp.entity.BudgetDetail[ budgetDetailPK=" + budgetDetailPK + " ]";
    }
